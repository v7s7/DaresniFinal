              ...
              <Label htmlFor="tutor" className="flex-1 cursor-pointer">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      I want to share my knowledge and help students achieve
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="text-sm">
                  ...
                  <p className="text-blue-700">
                    You'll complete your profile with teaching experience,
                    subjects, and rates. After admin verification, you can start
                    accepting students.
                  </p>
                </div>
              </div>
